metadata {
    definition (name: "btrial Fibaro Smoke Sensor", namespace: "btrial", author: "btrial") {
    ...
    preferences {
        ...
        input "wakeUpIntervalValue", "enum", title: "Wake up Interval",
                options: ["wakeup inactive", "70 minutes", "2 hour", "3 hours", "4 hours", "5 hours", "6 hours"], defaultValue: "${wakeUpIntervalValue}", displayDuringSetup: true
        ...
        input "temperatureReportInterval", "enum", title: "Temperature Report Interval",
                options: ["reports inactive", "1 minute", "5 minutes", "15 minutes", "30 minutes", "1 hour", "6 hours", "12 hours", "18 hours", "24 hours"], defaultValue: "${temperatureReportInterval}", displayDuringSetup: true
        input "temperatureReportHysteresis", "number", title: "Temperature Report Hysteresis", description: "Available settings: 1-100 (in 0.1C step) [0.1C - 10C]", range: "1..100", displayDuringSetup: true
        input "temperatureThreshold", "number", title: "Overheat Temperature Threshold", description: "Available settings: 1-100 (C), default 55 (C)", range: "0..100", displayDuringSetup: true
        input "excessTemperatureSignalingInterval", "enum", title: "Excess Temperature Signaling Interval",
                options: ["1 minute", "5 minutes", "15 minutes", "30 minutes", "1 hour", "6 hours", "12 hours", "18 hours", "24 hours"], defaultValue: "${excessTemperatureSignalingInterval}", displayDuringSetup: true
        input "lackOfZwaveRangeIndicationInterval", "enum", title: "Lack of Z-Wave Range Indication Interval",
                options: ["1 minute", "5 minutes", "15 minutes", "30 minutes", "1 hour", "6 hours", "12 hours", "18 hours", "24 hours"], defaultValue: "${lackOfZwaveRangeIndicationInterval}", displayDuringSetup: true
    }
    tiles (scale: 2){
...
// This sensor joins as a secure device if you tripple-click the button to include it
    ...
    if (!isSecured()) {
        ...
        request += zwave.wakeUpV1.wakeUpIntervalSet(seconds:wakeUpIntervalValueMap[wakeUpIntervalValue] ?: 0, nodeid:zwaveHubNodeId)
        ...
        if (temperatureReportInterval && temperatureReportInterval != "null") {
            ...
            request += zwave.configurationV1.configurationSet(parameterNumber: 20, size: 2, scaledConfigurationValue: 30)
        }
...
private def getWakeUpIntervalValueMap() { [
		"70 minutes"   : 4200,
        "2 hours"    : 7200,
        "3 hours"   : 10800,
        "4 hours"   : 14400,
